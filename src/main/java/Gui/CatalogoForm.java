...
public class CatalogoForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(modelList, javax.swing.GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void modelListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modelListActionPerformed
        ...
        showmodels(Model.Concesionario.getModelos());
    ...
    private void showmodels(ArrayList<Modelo> modelos) {
        int i;
        modelList.removeAll();
        for(i = 0; i < Model.Concesionario.getModelos().size();i++){
            modelList.add( Model.Concesionario.getModelos().get(i).getNombre());
        }
    }
}
